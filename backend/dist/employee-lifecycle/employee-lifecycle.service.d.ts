...
export declare class EmployeeLifecycleService {
    ...
    onboard(user: any, body: any): Promise<{
        employee: {
            id: string;
            name: string;
            email: string;
    ...
    convertOffer(user: any, body: any): Promise<{
        employee: {
            id: string;
            name: string;
            email: string;
    ...
    updateTask(taskId: string, status: string): Promise<{
        id: string;
        status: import("@prisma/client").$Enums.WorkItemStatus;
        updated_at: Date;
        title: string;
    ...
    updateBgv(bgvId: string, status: string, vendorNotes?: string): Promise<{
        id: string;
        createdAt: Date;
        status: import("@prisma/client").$Enums.VerificationStatus;
        updated_at: Date;
    ...
    transferRequest(user: any, body: any): Promise<{
        id: string;
        status: import("@prisma/client").$Enums.EmployeeChangeStatus;
        updated_at: Date;
        reason: string;
    ...
    promotionRequest(user: any, body: any): Promise<{
        id: string;
        createdAt: Date;
        source: string;
        employeeId: string;
