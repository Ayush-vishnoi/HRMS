...
const INITIAL_ASSETS: Asset[] = [
  ...
  { id: 'AST-005', assetTag: 'APX-AC-4017', category: 'Access Card', name: 'Employee Access Card', brand: 'MYLOTIC Security', model: 'RFID v2', serialNumber: 'RFID-EMP-2026-089', purchaseDate: '15 Jul 2026', purchaseCost: '₹850', warrantyUntil: '14 Jul 2027', status: 'Assigned', assignedTo: 'Ayush Vishnoi', employeeCode: 'EMP-2026-089', location: 'Bengaluru Office', condition: 'Good', lastChecked: '15 Jul 2026', notes: 'Access enabled for HQ, lab and cafeteria.' },
];
